...
SELECT ANIMALS.NAME
FROM ANIMALS
JOIN VISITS ON ANIMALS.ID = VISITS.AID
WHERE VID =
		(SELECT ID
			FROM VETS
...
SELECT *
FROM VETS
FULL JOIN SPECIALIZATIONS ON VETS.ID = SPECIALIZATIONS.VID
...
FROM ANIMALS
JOIN VISITS ON ANIMALS.ID = VISITS.AID
JOIN VETS ON VISITS.VID = VETS.ID
...
SELECT VETS.NAME,
	COUNT(*)
FROM VISITS
LEFT JOIN VETS ON VETS.ID = VISITS.VID
LEFT JOIN SPECIALIZATIONS ON SPECIALIZATIONS.VID = VISITS.VID
...
SELECT VETS.NAME,
	...
	COUNT(SPECIES.NAME)
FROM VISITS
LEFT JOIN ANIMALS ON ANIMALS.ID = VISITS.AID
LEFT JOIN VETS ON VETS.ID = VISITS.VID
